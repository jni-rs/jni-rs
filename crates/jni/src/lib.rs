...
//!
//! Firstly, JNI requires all native methods exported as "system" ABI function
//! to follow a standard naming pattern and accept specific parameters defined
//! by the JNI specification. This means we need to define our function
//! signature from Java, and then we can write Rust that will adhere to it.
//!
//! ### The Java side
//!
...
//! Run `javac -h . HelloWorld.java` and you'll get a `HelloWorld.h` output to
//! your directory. It should look something like this:
//!
//! ```c
...
//! API], provided by [`JavaVM`](struct.JavaVM.html).
//!
//! ## See Also
//!
//! ### Examples
...
//! [users-servo]:
//!     https://github.com/servo/servo/tree/master/ports/libsimpleservo
//! [users-ejb]:
