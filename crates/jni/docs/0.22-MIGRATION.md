...
- The introduction of various macros:
  - `bind_java_type` to simplify defining Rust types that bind to Java classes.
    ...
    - Bindings perform class + method/field ID caching and (amortized) runtime type checking
      to ensure correctness before use.
...
The biggest changes in 0.22 are to the JavaVM and thread attachment APIs.